...
public class CsControllerImpl implements CsController {
	...
	@RequestMapping(value= "/cs/csQnA.do" ,method={RequestMethod.POST,RequestMethod.GET})
	...
	@RequestMapping(value= "/cs/personalQ.do" ,method={RequestMethod.POST,RequestMethod.GET})
