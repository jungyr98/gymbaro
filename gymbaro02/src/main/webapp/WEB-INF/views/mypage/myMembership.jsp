  ...
  <div id="content" class="sub_wrap">
      ...
      <div class="myPage03_box tab_menu">
     	<div class="first_content">
          <div class="tab_btn">
               <ul>
                    <li class="active" style="background:#525F78;"><a href="#">회원권 내역</a></li>
               </ul>              
                <form name="searchForm" id="searchForm"  method="get" action="${contextPath}/mypage/myMembership.do">
                    ...
                    <c:forEach var="item" items="${membershipList}">
                    	<tr style="box-shadow: 0px 1px 3px 0px rgb(0 0 0 / 20%);">
                    		...
                    		<c:if test="${item.membership_state == '활성화'}">
                    			<span style="color:#0078ff;">${item.membership_state}</span>
                    		</c:if>
                    		<c:if test="${item.membership_state == '비활성화'}">
                    			<span style="color:tomato;">${item.membership_state}</span>
                    		</c:if>
                    		</td>
                    	</tr>
                    </c:forEach>
