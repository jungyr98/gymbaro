      ...
      <div id="content" class="sub_wrap">
        <nav>
          <ul>
            ...
            <li>
              <a href="${contextPath}/mypage/myPage05.do" class="active">내 게시물 관리</a>
            </li>
            <li>
  ...
  <div class="align_rt">
      <div class="myPage03_box tab_menu">
     	<div class="first_content">
          <div class="tab_btn">
               <ul>
                    <li class="active"><a href="#">댓글<img alt="coupon.png" src="${contextPath}/resources/image/comment.png"></a></li>
                    <li><a href="#">게시글<img alt="coupon.png" src="${contextPath}/resources/image/write.png"></a></li>
                    <li><a href="#">리뷰<img alt="coupon.png" src="${contextPath}/resources/image/like.png"></a></li>
               </ul>
