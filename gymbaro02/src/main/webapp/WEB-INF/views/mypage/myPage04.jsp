      ...
      <div id="content" class="sub_wrap">
        <nav>
          <ul>
            ...
            <li>
              <a href="${contextPath}/mypage/myPage04.do" class="active">예약 내역</a>
            </li>
            <li>
  ...
  <div class="align_rt">
      <div class="myPage03_box tab_menu">
     	<div class="first_content">
          <div class="tab_btn">
               <ul>
                    <li class="active"><a href="#">회원권 내역<img alt="coupon.png" src="${contextPath}/resources/image/id-card.png"></a></li>
                    <li><a href="#">취소 내역<img alt="coupon.png" src="${contextPath}/resources/image/cancel.png"></a></li>
               </ul>
          ...
          <div class="tab_cont">
               <table class="active myPage03_table">
                    <tr class="notice_board_first_tr">
                    	<td width=15%>회원권 번호</td>
                    	<td width=15%>시작 일자</td>
                    	<td width=35%>시설명</td>
                    	<td width=15%>결제 금액</td>
                    	<td width=10%>남은 기간</td>
                    	<td width=10%></td>
                    </tr>
               ...
               <table class="myPage03_table">
                   <tr class="notice_board_first_tr">
                    	<td width=15%>회원권 번호</td>
                    	<td width=15%>취소 일자</td>
                    	<td width=40%>시설명</td>
                    	<td width=15%>취소 사유</td>
                    	<td width=15%>취소 금액</td>
                    </tr>
                    <tr>
