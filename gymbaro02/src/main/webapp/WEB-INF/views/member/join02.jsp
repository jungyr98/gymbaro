  ...
  <div class="first_content">
	...
	<div class="button_box">
		...
		<c:if test="${join_type=='common'}">
			<a href="${contextPath}/join/join03_1.do?"><button id="button_02"><span>가입하기</span></button></a>
		</c:if>
		<c:if test="${join_type=='gym'}">
			<a href="${contextPath}/join/join03_2.do?"><button id="button_02"><span>가입하기</span></button></a>
		</c:if>
	</div>
  </div>
 </div>
