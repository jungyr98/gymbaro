	...
	<form action="${contextPath}/member/addMember.do" method="post">	
		<table border="1" width="730px;" style="margin: 0 auto;">
			...
			<thead>
				...
				<td>
						<input type="text" id="reginum1" name="reginum1" size="50" style="width:20%;"> - 
						<input type="text" id="reginum2" name="reginum2" size="5" style="width:20%;"> - 
						<input type="text" id="reginum3" name="reginum3" size="5" style="width:20%;">
						<input type="button"  id="hp" class="form_btn" value="등록하기" onClick=""/>
					</td>
				</tr>
			</thead>	
			<thead>
		...
		<div class="button_box">
     	 ...
     	 <a href="${contextPath}/join/join_04.do"><button id="button_02"><span>가입하기</span></button></a>
   		</div>
   </form>
   </div>
  </div>
